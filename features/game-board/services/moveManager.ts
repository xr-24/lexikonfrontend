...
import { calculateTurnScore, type TurnScore } from '../../scoring/services/scoreCalculator';
import { PowerUpManager } from '../../tile-system/services/powerUpManager';
...
export class MoveManager {
  ...
  async executeMove(
    ...
    player: Player,
    pendingTiles: PlacedTile[]
  ): Promise<MoveResult & { collectedPowerUps: PowerUp[]; modifiers: any }> {
